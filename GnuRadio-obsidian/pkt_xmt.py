...
class pkt_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_hackrf_sink_0.set_frequency(0, 429.22e6)
        self.soapy_hackrf_sink_0.set_gain(0, 'AMP', False)
        self.soapy_hackrf_sink_0.set_gain(0, 'VGA', min(max(37, 0.0), 47.0))
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.cons(pmt.PMT_NIL,pmt.init_u8vector(9,(71,78,85,32,82,97,100,105,111))), 10)
